...
public class SaveService
{
    ...
    public void SaveNow(System.Numerics.Vector3 cameraPos, float yaw, float pitch)
    {
        try
        {
            var state = new SaveState
            {
                ...
                MarathonAwarded = _stats.MarathonAwarded,
                ...
                LongestLifeSeconds = _stats.LongestLifeSeconds,
    ...
    public (System.Numerics.Vector3 Position, float Yaw, float Pitch)? TryLoad()
    {
        try
        {
            ...
            _stats.SeedKindKillsFromSave(
                ...
                state.DeerKills, state.BearKills);
            _stats.SeedAchievementsFromSave(
                ...
                state.BearSlayerAwarded, state.MarathonAwarded);
            ...
            _stats.SeedLongestLifeFromSave(state.LongestLifeSeconds);
    ...
    public sealed class SaveState
    {
        ...
        public bool MarathonAwarded { get; set; }
